...
public class CustomClassLoader extends SecureClassLoader {
     ...
     */
    public static final CustomClassLoader GLOBAL_CLASSLOADER = new CustomClassLoader(Thread.currentThread().getContextClassLoader());
     ...
     */
    public synchronized CustomClassLoader add(InputStream jarStream) {
     ...
     * @return the custom class loader
     */
    public synchronized CustomClassLoader addJarBytes(byte[] bytes) {
     ...
     * @return the custom class loader
     */
    public synchronized CustomClassLoader add(String className, byte[] bytes) {
